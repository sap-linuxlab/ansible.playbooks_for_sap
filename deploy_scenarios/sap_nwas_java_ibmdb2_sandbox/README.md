...
This Ansible Playbook automates the deployment of an SAP NetWeaver JAVA on IBM Db2 in a single-host environment.  
...
### SAP NetWeaver JAVA with IBM Db2 Installation
