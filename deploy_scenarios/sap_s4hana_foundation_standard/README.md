# Ansible Playbook for SAP S/4HANA Foundation - Standard Installation

## Overview

This Ansible Playbook automates the deployment of an SAP S/4HANA Foundation system with the SAP ABAP Platform and the SAP HANA database server on separate hosts. 
