# Ansible Playbook for SAP HANA Database - Sandbox Installation

## Overview

This Ansible Playbook automates the deployment of an SAP HANA Sandbox Database in a single-host environment.  
