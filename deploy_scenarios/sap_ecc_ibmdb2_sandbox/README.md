# Ansible Playbook for SAP Business Suite (ECC) with IBM Db2 - Sandbox Installation

## Overview

This Ansible Playbook automates the deployment an SAP Business Suite (ECC) with IBM Db2 in a single-host environment.  
...
### SAP Business Suite (ECC) with IBM Db2 Installation
