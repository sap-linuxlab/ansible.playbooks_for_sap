# Ansible Playbook for IDES for SAP Business Suite (ECC) with IBM Db2 - Sandbox Installation

## Overview

This Ansible Playbook automates the deployment an IDES for SAP Business Suite (ECC) with IBM Db2 in a single-host environment.  
...
### IDES for SAP Business Suite (ECC) with IBM Db2 Installation

6. **Install IDES for SAP Business Suite (ECC):** The `SWPM` tool is used to install the SAP application.
