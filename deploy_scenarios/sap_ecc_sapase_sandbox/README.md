# Ansible Playbook for SAP Business Suite (ECC) with SAP ASE - Sandbox Installation

## Overview

This Ansible Playbook automates the deployment an SAP Business Suite (ECC) with SAP ASE in a single-host environment.  
...
### SAP Business Suite (ECC) with SAP ASE Installation
